...
INSERT INTO "characteristics" ("system_key", "name_ukr", "category") VALUES
                                                                         ('uni_kpi', 'НТУУ "КПІ"', 'university_kiev'),
                                                                         ('uni_knu', 'КНУ ім. Шевченка', 'university_kiev'),
                                                                         ('uni_nmu', 'НМУ ім. Богомольця', 'university_kiev'),
                                                                         ('uni_knteu', 'КНТЕУ', 'university_kiev'),
                                                                         ('uni_knukim', 'КНУКіМ', 'university_kiev'),
                                                                         ('uni_kneu', 'КНЕУ ім. Гетьмана', 'university_kiev'),
                                                                         ('uni_nau', 'НАУ', 'university_kiev'),
                                                                         ('uni_naukma', 'НаУКМА', 'university_kiev'),
                                                                         ('uni_npu', 'НПУ ім. Драгоманова', 'university_kiev'),
                                                                         ('uni_knuba', 'КНУБА (КІСІ)', 'university_kiev'),
                                                                         ('uni_nubip', 'НУБіП України', 'university_kiev'),
                                                                         ...
                                                                         ('uni_onmu', 'Одеський національний морський університет', 'university_odesa'),
                                                                         ...
                                                                         ('uni_umsf', 'Університет митної справи та фінансів', 'university_dnipro'),
                                                                         ('uni_vnmu', 'ВНМУ ім. Пирогова', 'university_vinnytsya'),
                                                                         ('uni_vntu', 'ВНТУ', 'university_vinnytsya'),
                                                                         ('uni_donnu_vin', 'ДонНУ ім. Стуса (м. Вінниця)', 'university_vinnytsya'),
                                                                         ('uni_vdpu', 'ВДПУ ім. Коцюбинського', 'university_vinnytsya'),
                                                                         ('uni_znu', 'ЗНУ', 'university_zaporizhzhya'),
                                                                         ('uni_zp', 'НУ "Запорізька політехніка"', 'university_zaporizhzhya'),
                                                                         ('uni_zdmfu', 'ЗДМФУ', 'university_zaporizhzhya'),
                                                                         ('uni_pnu', 'ПНУ ім. Стефаника', 'university_ivano_frankivsk'),
                                                                         ('uni_ifntung', 'ІФНТУНГ', 'university_ivano_frankivsk'),
                                                                         ('uni_ifnmu', 'ІФНМУ', 'university_ivano_frankivsk'),
                                                                         ('uni_chnu', 'ЧНУ ім. Федьковича', 'university_chernivtsi'),
                                                                         ('uni_bdmu', 'БДМУ', 'university_chernivtsi'),
                                                                         ('uni_chtei', 'ЧТЕІ ДТЕУ', 'university_chernivtsi'),
                                                                         ('uni_nupp', 'НУ "Полтавська політехніка"', 'university_poltava'),
                                                                         ('uni_pnpu', 'ПНПУ ім. Короленка', 'university_poltava'),
                                                                         ('uni_pdau_poltava', 'Полтавський державний аграрний університет', 'university_poltava'),
                                                                         ('uni_sumdu', 'СумДУ', 'university_sumy'),
                                                                         ('uni_snau', 'СНАУ', 'university_sumy'),
                                                                         ('uni_sumdpu', 'СумДПУ ім. Макаренка', 'university_sumy'),
                                                                         ('uni_uzhnu', 'УжНУ', 'university_uzhgorod'),
                                                                         ('uni_zunu', 'ЗУНУ', 'university_ternopil'),
                                                                         ('uni_tnmu', 'ТНМУ ім. Горбачевського', 'university_ternopil'),
                                                                         ('uni_tnpu', 'ТНПУ ім. Гнатюка', 'university_ternopil'),
                                                                         ('uni_nuvhp', 'НУВГП', 'university_rivne'),
                                                                         ('uni_rdhu', 'РДГУ', 'university_rivne'),
                                                                         ('uni_vnu', 'ВНУ ім. Лесі Українки', 'university_lutsk'),
                                                                         ('uni_lntu', 'ЛНТУ', 'university_lutsk'),
                                                                         ('uni_khnu_km', 'ХНУ (Хмельницький)', 'university_khmelnytskyi'),
                                                                         ('uni_nu_chp', 'НУ "Чернігівська політехніка"', 'university_chernihiv'),
                                                                         ('uni_nu_chc', 'НУ "Чернігівський колегіум" ім. Шевченка', 'university_chernihiv'),
                                                                         ('uni_chnu_mk', 'ЧНУ ім. Петра Могили', 'university_mykolaiv'),
                                                                         ('uni_nuk', 'НУК ім. Макарова', 'university_mykolaiv'),
                                                                         ('uni_mnau', 'Миколаївський національний аграрний університет', 'university_mykolaiv');
