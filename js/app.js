...
import {
    ...
    loadProfileData, handleAvatarUpload, setupProfileEventListeners,
    loadSettingsData, handleSettingsSubmission,
    setupHomepageFilters // Додали функцію для фільтрів
} from './modules/forms.js';

import { initializeNavigation, toggleFilters, setupNavLinks } from './modules/navigation.js';
